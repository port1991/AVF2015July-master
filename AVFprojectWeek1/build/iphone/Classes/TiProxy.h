...
//Rare exceptions to indicate a bug in the _avfprojectweek1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for AVFprojectWeek1 proxies.
 */
