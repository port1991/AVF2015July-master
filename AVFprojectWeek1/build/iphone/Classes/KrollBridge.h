...
@interface AVFprojectWeek1Object : KrollCoverageObject {
#else
@interface AVFprojectWeek1Object : KrollObject {
#endif
@private
...
extern NSString * AVFprojectWeek1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AVFprojectWeek1Object *_avfprojectweek1;
    KrollObject* console;
	BOOL shutdown;
