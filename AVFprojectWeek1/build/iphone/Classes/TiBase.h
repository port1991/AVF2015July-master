...
// in simulator we redefine to format for AVFprojectWeek1 Developer console
...
{\
	NSString * exceptionName = [@"org.avfprojectweek1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.avfprojectweek1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAVFprojectWeek1NativeItemNone = -1, 
	UIAVFprojectWeek1NativeItemSpinner = -2,
	UIAVFprojectWeek1NativeItemProgressBar = -3,
	
	UIAVFprojectWeek1NativeItemSlider = -4,
	UIAVFprojectWeek1NativeItemSwitch = -5,
	UIAVFprojectWeek1NativeItemMultiButton = -6,
	UIAVFprojectWeek1NativeItemSegmented = -7,
	
	UIAVFprojectWeek1NativeItemTextView = -8,
	UIAVFprojectWeek1NativeItemTextField = -9,
	UIAVFprojectWeek1NativeItemSearchBar = -10,
	
	UIAVFprojectWeek1NativeItemPicker = -11,
	UIAVFprojectWeek1NativeItemDatePicker = -12,
	
	UIAVFprojectWeek1NativeItemInfoLight = -13,
	UIAVFprojectWeek1NativeItemInfoDark = -14,
	
	UIAVFprojectWeek1NativeItemDisclosure = -15,
	
	UIAVFprojectWeek1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AVFprojectWeek1 instances of
