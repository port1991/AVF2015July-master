...
/**
 The base class for all AVFprojectWeek1 modules
 */
...
/**
 AVFprojectWeek1 Platform calls this method on startup.
 */
-(void)startup;

/**
 AVFprojectWeek1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 AVFprojectWeek1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 AVFprojectWeek1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 AVFprojectWeek1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
