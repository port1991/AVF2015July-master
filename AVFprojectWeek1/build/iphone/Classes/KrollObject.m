...
//@interface AVFprojectWeek1Object : NSObject
//@end

@interface AVFprojectWeek1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AVFprojectWeek1Object class]])
		{
			for (NSString *key in [[(AVFprojectWeek1Object*)o modules] allKeys])
			{
