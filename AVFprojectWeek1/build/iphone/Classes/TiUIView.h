...
/**
 Base class for all AVFprojectWeek1 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the AVFprojectWeek1 view hierarchy (such as wrapped iOS UIViews) was touched.
